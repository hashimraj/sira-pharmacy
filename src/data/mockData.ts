...
import ceraveFoamingCleanser from "@/assets/products/ceraveFoamingCleanser.jpg";
import simpleRefreshingWash from "@/assets/products/simpleRefreshingWash.jpg";
import simpleSoothingToner from "@/assets/products/simpleSoothingToner.jpg";
import simplePurifyingGelWash from "@/assets/products/simplePurifyingGelWash.jpg";
import ceraveSASmoothingCleanser from "@/assets/products/ceraveSASmoothingCleanser.jpeg";
import anuaNiacinamideSerum from "@/assets/products/anuaNiacinamideSerum.jpg";
import anuaAzelaicSerum from "@/assets/products/anuaAzelaicSerum.jpeg";
import bentonAloePropolisGel from "@/assets/products/bentonAloePropolisGel.jpg";
...
export const products: Product[] = [
  ...
  // 21 CeraVe Foaming Facial Cleanser
{
  id: "p21",
  ...
  images: [ ceraveFoamingCleanser ],
  description: "A gentle, foaming gel cleanser for normal to oily skin that removes excess oil and makeup while maintaining the skin barrier.",
  fullDescription: "Developed with dermatologists, CeraVe Foaming Facial Cleanser has a unique formula with three essential ceramides (1, 3, 6-II) that cleanses and removes oil without disrupting the protective skin barrier. The gel-based formula transforms into a weightless foam to sweep away dirt and impurities.",
  ingredients: "Aqua/Water, Cocamidopropyl Hydroxysultaine, Glycerin, Sodium Lauroyl Sarcosinate, Niacinamide, Ceramide NP, Ceramide AP, Ceramide EOP, Hyaluronic Acid, Cholesterol",
  howToUse: "Wet skin with lukewarm water. Massage cleanser into skin in a gentle, circular motion. Rinse.",
  warnings: "Avoid direct contact with eyes. If contact occurs, rinse thoroughly with water.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.8,
  reviewCount: 15400,
  tags: ["oil-control", "fragrance-free", "dermatologist-recommended"],
  skinType: ["normal", "oily", "sensitive"],
  reviews: sampleReviews,
},
// 22 Simple Refreshing Facial Wash
{
  id: "p22",
  ...
  subcategory: "cleansers",
  price: 1500, 
  image: simpleRefreshingWash,
  images: [ simpleRefreshingWash ],
  description: "A 100% soap-free gel cleanser that removes dirt, oil, and impurities without stripping the skin.",
  fullDescription: "Simple Refreshing Facial Wash is a gentle, water-based cleanser enriched with Pro-Vitamin B5 and Vitamin E. It uses Pro Amino Acid Technology to strengthen the skin barrier while providing a thorough yet non-irritating cleanse. Ideal for sensitive skin.",
  ingredients: "Aqua, Cocamidopropyl Betaine, Propylene Glycol, Hydroxypropyl Methylcellulose, Panthenol, Tocopheryl Acetate, Pantolactone, Sodium Hydroxide, Citric Acid.",
  howToUse: "Wet face with warm water, squeeze a small amount into hands and work into a lather. Massage gently in a circular motion onto wet skin, then rinse and pat dry.",
  warnings: "Avoid the delicate eye area. For external use only.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.7,
  reviewCount: 1250,
  tags: ["soap-free", "sensitive-skin", "fragrance-free", "vegan"],
  skinType: ["all", "sensitive"],
  reviews: sampleReviews,
},
// 23 Simple Soothing Facial Toner
{
  id: "p23",
  ...
  subcategory: "toners", 
  price: 1500, 
  image: simpleSoothingToner,
  images: [ simpleSoothingToner ],
  description: "A 100% alcohol-free toner that removes the last traces of cleanser and rebalances skin pH.",
  fullDescription: "This soothing toner features a special blend of skin-toning goodness, including Pro-Vitamin B5, Witch Hazel, and Allantoin. It helps to keep skin toned and refreshed without leaving it feeling dry or tight. Ideal for sensitive skin.",
  ingredients: "Aqua, Hydrogenated Starch Hydrolysate, Hamamelis Virginiana Water (Witch Hazel), Allantoin, Panthenol, Niacinamide, Chamomilla Recutita Flower Extract.",
  howToUse: "Apply a generous amount to a cotton pad and wipe in gentle upward movements over skin after cleansing.",
  warnings: "For external use only. Avoid getting into your eyes.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.6,
  reviewCount: 940,
  tags: ["alcohol-free", "pH-balancing", "soothing", "sensitive-skin"],
  skinType: ["all", "sensitive"],
  reviews: sampleReviews,
},
// 24 Simple Daily Skin Detox Purifying Gel Wash
{
  id: "p24",
  name: "Simple Daily Skin Detox Purifying Gel Wash",
  brand: "Simple",
  category: "skincare",
  subcategory: "cleansers",
  price: 1550, 
  image: simplePurifyingGelWash,
  images: [ simplePurifyingGelWash ],
  description: "An oil-busting gel wash with Witch Hazel and Zinc to deeply cleanse and clarify spot-prone skin.",
  fullDescription: "Simple Daily Skin Detox Purifying Gel Wash is your new secret weapon for fighting clogged pores and oily shine. Its unique formula is made with a detoxifying blend of thyme, zinc, and witch hazel to deeply clean dirt, oil, and makeup while remaining gentle on the skin. 100% soap-free and perfect for oily skin types.",
  ingredients: "Aqua, Hamamelis Virginiana Leaf Water (Witch Hazel), Cocamidopropyl Betaine, Glycerin, Sodium Laureth Sulfate, PEG-7 Glyceryl Cocoate, Zinc PCA, Panthenol, Niacinamide.",
  howToUse: "Lather a small amount in your hands and massage onto wet skin. Rinse thoroughly with water.",
  warnings: "For external use only. Avoid contact with eyes.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.5,
  reviewCount: 520,
  tags: ["oil-control", "anti-blemish", "witch-hazel", "zinc"],
  skinType: ["oily", "combination"],
  reviews: sampleReviews,
},
// 25 CeraVe SA Smoothing Cleanser
{
  id: "p25",
  ...
  subcategory: "cleansers",
  price: 3000,
  image: ceraveSASmoothingCleanser,
  images: [ ceraveSASmoothingCleanser ],
  description: "A gentle salicylic acid cleanser that exfoliates and smoothes rough, bumpy skin without disrupting the skin barrier.",
  fullDescription: "Developed with dermatologists, CeraVe SA Smoothing Cleanser is formulated to effectively exfoliate, soften, and smooth dry, rough, bumpy skin. Unlike some exfoliating cleansers, it contains no harsh microbeads and is enriched with 3 essential ceramides, salicylic acid, and hyaluronic acid to hydrate and protect the skin's natural barrier.",
  ...
  howToUse: "Massage cleanser onto wet skin in a gentle, circular motion. Rinse. For best results, use daily.",
  warnings: "Avoid direct contact with eyes. If contact occurs, rinse thoroughly with water. Use a sunscreen while using this product as it contains Salicylic Acid which may increase sun sensitivity.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.8,
  reviewCount: 3200,
  tags: ["exfoliating", "salicylic-acid", "rough-and-bumpy-skin", "fragrance-free"],
  skinType: ["dry", "rough", "bumpy", "acne-prone"],
  reviews: sampleReviews,
},
// 26 Anua Niacinamide 10% + TXA 4% Serum
{
  id: "p26",
  ...
  price: 3300,
  image: anuaNiacinamideSerum,
  images: [ anuaNiacinamideSerum ],
  description: "A potent brightening serum with 10% Niacinamide and 4% Tranexamic Acid to fade stubborn dark spots and acne scars.",
  fullDescription: "Anua Niacinamide 10% + TXA 4% Serum is a watery, lightweight treatment designed to address hyperpigmentation and uneven skin tone. It features a powerful trio of Niacinamide, Tranexamic Acid, and 2% Arbutin to limit melanin production and brighten the complexion. Infused with Hyaluronic Acid and Ceramides, it hydrates and strengthens the skin barrier while targeting discoloration.",
  ingredients: "Aqua, Glycerin, Niacinamide (10%), Tranexamic Acid (4%), Butylene Glycol, Arbutin (2%), Sodium Hyaluronate, Alpha-Arbutin, Ceramide NP, Panthenol, Hyaluronic Acid, Centella Asiatica Extract.",
  howToUse: "After cleansing and toning, apply 2-3 drops to the face and neck. Gently pat into the skin until fully absorbed. Use morning and night.",
  warnings: "For external use only. Conduct a patch test before use. Always apply SPF 30 or higher during the day to protect skin and prevent further pigmentation.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.7,
  reviewCount: 712,
  tags: ["brightening", "dark-spot-corrector", "k-beauty", "glass-skin"],
  skinType: ["all", "acne-prone", "sensitive"],
  reviews: sampleReviews,
},
// 27 Anua Azelaic Acid 10 Hyaluron Redness Soothing Serum
{
  id: "p27",
  ...
  subcategory: "acne-treatment",
  price: 3350,
  image: anuaAzelaicSerum,
  images: [ anuaAzelaicSerum ],
  description: "A lightweight, soothing serum with 10% Azelaic Acid and Hyaluronic Acid to calm redness and improve skin texture.",
  fullDescription: "Anua Azelaic Acid 10 Hyaluron Redness Soothing Serum is a gentle yet powerful formula designed for sensitive and acne-prone skin. It features 10% Azelaic Acid to visibly reduce redness, inflammation, and fade post-acne marks. Infused with multiple weights of Hyaluronic Acid, Centella Asiatica, and Green Tea Leaf Water, it deeply hydrates and strengthens the skin barrier while promoting a clearer, more balanced complexion.",
  ingredients: "Aqua, Azelaic Acid (10%), Glycerin, Butylene Glycol, Panthenol, Sodium Hyaluronate, Centella Asiatica Extract, Aloe Barbadensis Leaf Juice, Camellia Sinensis (Green Tea) Leaf Water, Zinc PCA.",
  howToUse: "After cleansing and toning, apply 2-3 drops to the face, focusing on areas with redness or irritation. Start once daily and increase usage as skin tolerates. Always follow with sunscreen during the day.",
  warnings: "For external use only. Avoid direct contact with eyes. Patch test before first use. Azelaic acid can increase sun sensitivity; use daily sun protection.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.8,
  reviewCount: 450,
  tags: ["redness-relief", "soothing", "acne-prone", "k-beauty", "alcohol-free"],
  skinType: ["sensitive", "acne-prone", "oily", "combination"],
  reviews: sampleReviews,
},
// 28 Benton Aloe Propolis Soothing Gel
{
  id: "p28",
  ...
  subcategory: "moisturizers",
  price: 2900,
  image: bentonAloePropolisGel,
  images: [ bentonAloePropolisGel ],
  description: "A fragrance-free, refreshing gel moisturizer packed with 80% Aloe and 10% Propolis to calm and hydrate skin.",
  fullDescription: "Benton Aloe Propolis Soothing Gel is a lightweight facial moisturizer designed to replenish and hydrate all skin types, especially oily and acne-prone skin. It contains over 80% Aloe Barbadensis Leaf Juice to soothe redness and irritation, combined with 10% Propolis Extract, known for its antibacterial and anti-inflammatory properties. This non-greasy formula helps fade acne scars, brighten skin tone, and maintain a healthy moisture barrier without leaving a sticky residue.",
  ingredients: "Aloe Barbadensis Leaf Juice (80%), Propolis Extract (10%), Glycerin, Pentylene Glycol, Zanthoxylum Piperitum Fruit Extract, Pulsatilla Koreana Extract, Usnea Barbata (Lichen) Extract, Arginine, Cucumis Sativus (Cucumber) Fruit Extract, Portulaca Oleracea Extract, Citrus Limon (Lemon) Fruit Extract, Camellia Sinensis Leaf Extract, Chamomilla Recutita (Matricaria) Flower Extract.",
  howToUse: "After cleansing, toning, and applying treatment products, dispense a small amount and gently pat over the entire face until fully absorbed. Follow with SPF during the day.",
  warnings: "For external use only. Avoid contact with eyes. Stop use and consult a doctor if rash or irritation develops.",
  inStock: true,
  isPrescriptionRequired: false,
  rating: 4.7,
  reviewCount: 1850,
  tags: ["oil-free", "soothing", "acne-prone", "fragrance-free", "k-beauty"],
  skinType: ["all", "oily", "acne-prone", "sensitive"],
  reviews: sampleReviews,
},
